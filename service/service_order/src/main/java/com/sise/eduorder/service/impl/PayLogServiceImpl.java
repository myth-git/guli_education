...
import com.sise.eduorder.mapper.PayLogMapper;
import com.sise.eduorder.service.OrderService;
import com.sise.eduorder.service.PayLogService;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.sise.eduorder.utils.HttpClient;
...
public class PayLogServiceImpl extends ServiceImpl<PayLogMapper, PayLog> implements PayLogService {
    ...
    public Map createNatvie(String orderNo) {
        try {
            ...
            //设置xml格式的参数  商户key
            // 将m集合用商户key加密并转化成xml格式传给client返回一个微信支付的地址
